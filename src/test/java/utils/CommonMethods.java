...
//        List<WebElement> options = select.getOptions();
    ...
    /**
     * This element take screeenshots based on a given webelemenet
     * @param element which its screenshot needs to be taken
     * @param fileName screenshots fileame, defaulted to .png format (can be changed to .jpeg within the method if needed).
    ...
    public static String getTimeStamp(){
        Date date = new Date();
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd_HH_mm_ss_SS");  //YYYY-MM-DD_hour_min_second_milisecond
        String getTimeStamp = simpleDateFormat.format(date.getTime());
        return getTimeStamp;
    }
